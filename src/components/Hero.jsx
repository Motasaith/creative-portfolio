...
const Hero = () => {
  return (
    <section id="home" className="min-h-screen flex flex-col md:flex-row items-center justify-center p-8 md:p-20 pt-32 md:pt-20 bg-transparent text-white overflow-hidden relative">
      {/* Background Elements */}
      ...
      <div className="z-10 flex flex-col md:flex-row items-center justify-between w-full max-w-6xl">
        ...
        >
          <h1 className="text-4xl leading-tight md:text-7xl font-bold mb-4 font-sans tracking-tight">
